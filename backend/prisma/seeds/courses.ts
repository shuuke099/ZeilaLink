...
export async function seedCourses(
  ...
  const courses = [
    ...
    {
      course: {
        id: "seed-course-react-development",
        slug: "react-application-development",
        name: "React Application Development",
        nameSo: "Horumarinta Barnaamijyada React",
        description: "Build responsive web applications with React, reusable components, state management, and modern frontend practices.",
        descriptionSo: "Ku dhis barnaamijyo web oo responsive ah React, components dib loo isticmaali karo iyo hababka casriga ah ee frontend-ka.",
        providerId: providers.twinCitiesTechAcademy.id,
        category: "Technology",
        level: "Intermediate",
        duration: "8 weeks",
        ...
        country: "US",
        timezone: "America/Chicago",
        onlineUrl: "https://example.com/tech-academy/react",
        startDate: new Date("2026-10-05T00:00:00.000Z"),
        endDate: new Date("2026-11-27T00:00:00.000Z"),
        registrationDeadline: new Date("2026-10-01T23:59:59.000Z"),
        schedule: "Tuesday and Thursday, 6:00 PM - 8:00 PM",
        scheduleSo: "Talaado iyo Khamiis, 6:00 PM - 8:00 PM",
        cost: 449,
        currency: "USD",
        enrollmentUrl: "https://example.com/tech-academy/register/react",
        enrollmentOpen: true,
        imageUrl: "https://images.unsplash.com/photo-1633356122544-f134324a6cee?auto=format&fit=crop&w=1200&q=80",
        gallery: ["https://images.unsplash.com/photo-1633356122544-f134324a6cee?auto=format&fit=crop&w=1200&q=80"],
        providesCertificate: true,
        certificateUrl: null,
        published: true,
        featured: true,
      ...
      skillIds: [skills.javascript.id, skills.react.id],
    },
    {
      course: {
        id: "seed-course-database-fundamentals",
        slug: "database-fundamentals",
        name: "Database Fundamentals",
        nameSo: "Aasaaska Kaydka Xogta",
        description: "Learn relational database design, SQL queries, data modeling, and practical database management.",
        descriptionSo: "Baro naqshadeynta database-ka, SQL, qaabeynta xogta iyo maamulka kaydka xogta.",
        providerId: providers.twinCitiesTechAcademy.id,
        category: "Technology",
        level: "Beginner",
        duration: "6 weeks",
        ...
        country: "US",
        timezone: "America/Chicago",
        onlineUrl: "https://example.com/tech-academy/databases",
        startDate: new Date("2026-10-12T00:00:00.000Z"),
        endDate: new Date("2026-11-20T00:00:00.000Z"),
        registrationDeadline: new Date("2026-10-08T23:59:59.000Z"),
        schedule: "Monday and Wednesday, 6:00 PM - 8:00 PM",
        scheduleSo: "Isniin iyo Arbaco, 6:00 PM - 8:00 PM",
        cost: 299,
        currency: "USD",
        enrollmentUrl: "https://example.com/tech-academy/register/databases",
        enrollmentOpen: true,
        imageUrl: "https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80",
        gallery: ["https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&w=1200&q=80"],
        providesCertificate: true,
        certificateUrl: null,
        published: true,
        featured: true,
      ...
      skillIds: [skills.databases.id],
    },
    {
      course: {
        id: "seed-course-inventory-management",
        slug: "inventory-management-essentials",
        name: "Inventory Management Essentials",
        nameSo: "Aasaaska Maamulka Alaabta",
        description: "Develop inventory tracking, stock control, order fulfillment, and warehouse coordination skills.",
        descriptionSo: "Horumari xirfadaha raadraaca alaabta, xakameynta kaydka, dalabyada iyo isku dubbaridka bakhaarka.",
        providerId: providers.metroWorkforceCenter.id,
        category: "Operations",
        level: "Intermediate",
        duration: "4 weeks",
        ...
        cost: 99,
        currency: "USD",
        enrollmentUrl: "https://example.com/workforce/register/inventory",
        enrollmentOpen: true,
        imageUrl: "https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&w=1200&q=80",
        gallery: ["https://images.unsplash.com/photo-1553413077-190dd305871c?auto=format&fit=crop&w=1200&q=80"],
        providesCertificate: true,
        certificateUrl: null,
        published: true,
        featured: true,
    ...
    {
      course: {
        id: "seed-course-workplace-communication",
        slug: "workplace-communication",
        name: "Workplace Communication",
        nameSo: "Isgaarsiinta Goobta Shaqada",
        description: "Strengthen professional communication, teamwork, customer interactions, and workplace conflict resolution.",
        descriptionSo: "Xooji isgaarsiinta xirfadeed, wada shaqeynta, la macaamilka macaamiisha iyo xalinta khilaafaadka.",
        providerId: providers.northstarCareerCenter.id,
        category: "Business",
        level: "Beginner",
        duration: "3 weeks",
        ...
        registrationDeadline: new Date("2026-10-15T23:59:59.000Z"),
        schedule: "Monday and Wednesday, 5:30 PM - 7:30 PM",
        scheduleSo: "Isniin iyo Arbaco, 5:30 PM - 7:30 PM",
        cost: 0,
        currency: "USD",
        enrollmentUrl: "https://example.com/northstar/workplace-communication",
        enrollmentOpen: true,
        imageUrl: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=1200&q=80",
        gallery: ["https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=1200&q=80"],
        providesCertificate: true,
        certificateUrl: null,
        published: true,
        featured: true,
  ...
  return {
    ...
    reactDevelopment: seededCourses[6],
    databaseFundamentals: seededCourses[7],
    inventoryManagement: seededCourses[8],
    workplaceCommunication: seededCourses[9],
  };
}
