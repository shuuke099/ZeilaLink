...
import { Award, BookOpen, CalendarDays, Check, CheckCircle2, Clock3, Copy, DollarSign, ExternalLink, FileCheck2, Globe2, GraduationCap, Languages, Mail, MapPin, Monitor, Phone, Share2, ShieldCheck, Star, UserRound, UsersRound } from 'lucide-react';
...
const courseContentSo: Record<string, string> = {
  ...
  'Be at least 18 years old': 'Daâ€™daadu ha ahaato ugu yaraan 18 sano',
  ...
  'Meet Summitâ€™s placement-test requirements': 'Buuxi shuruudaha imtixaanka meelaynta ee Summit',
...
const translateDescriptionToSomali = (value: string) => {
  const translations: Array<[string, string]> = [
    ...
    ['Applicants must complete the required admissions and financial-aid process; eligibility is determined by Summit.', 'Codsadayaashu waa inay dhammaystiraan habraaca gelitaanka iyo kaalmada dhaqaale ee loo baahan yahay; u-qalmitaankana Summit ayaa goâ€™aamisa.'],
    ...
    ['Cover image: AI-generated illustration, not a photograph of Summitâ€™s campus or students.', 'Sawirka daboolka: waa sawir ay samaysay AI, mana aha sawir laga qaaday xarunta Summit ama ardaydeeda.'],
...
export default function TrainingDetailClient({ initialTraining: training, publicPath }: Props) {
  ...
  return <div className="detail-readable min-h-screen bg-[#fafafe] text-slate-900 dark:bg-slate-950 dark:text-slate-100"><Navbar /><main className="mx-auto max-w-[1440px] px-4 pb-14 pt-20 sm:px-6 lg:px-8"><div className="grid items-start gap-4 lg:grid-cols-[minmax(0,1fr)_330px]">
    <div className="min-w-0 space-y-4">
      ...
      <ReviewSection targetType="course" targetId={training.id} initialRating={training.rating} initialCount={training.reviewsCount} />
